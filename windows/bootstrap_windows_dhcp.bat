...
@powershell -NoProfile -ExecutionPolicy Bypass -Command "Add-DhcpServerv4Scope -Name 10.10.10.X -StartRange 10.10.20.50 -EndRange 10.10.20.250 -SubnetMask 255.255.255.0"
